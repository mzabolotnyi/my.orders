...
class Version20170228201305 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE order_row (id INT AUTO_INCREMENT NOT NULL, order_id INT NOT NULL, type_id INT NOT NULL, size_id INT NOT NULL, shop_id INT NOT NULL, product VARCHAR(255) NOT NULL, purchase_price INT NOT NULL, selling_price INT NOT NULL, weight_included TINYINT(1) NOT NULL, weight_cost INT NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_C76BB9BB8D9F6D38 (order_id), INDEX IDX_C76BB9BBC54C8C93 (type_id), INDEX IDX_C76BB9BB498DA827 (size_id), INDEX IDX_C76BB9BB4D16C4DD (shop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
