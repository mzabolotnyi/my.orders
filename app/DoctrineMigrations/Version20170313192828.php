...
class Version20170313192828 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE order_row ADD CONSTRAINT FK_C76BB9BB12469DE2 FOREIGN KEY (category_id) REFERENCES size_category (id)');
